...
export const recipeFinderMedia = [
    ...
    {
        type: "mp4",
        label: "Implemented a seamless search experience using React and Redux Toolkit, allowing users to type recipes or ingredients, hit search, and scroll through paginated results.",
        imgPath: "/assets/media/recipe-finder/search_recipes.mp4",
        alt: "Searching for recipes and scrolling through results",
    },
    {
        type: "mp4",
        label: "Enhanced user engagement with smooth pagination navigation, enabling users to traverse multiple pages of recipes effortlessly.",
        imgPath: "/assets/media/recipe-finder/pagination.mp4",
        alt: "Navigating through paginated recipe results",
    },
    {
        type: "mp4",
        label: "Introduced a filter modal to refine search results based on max calories per serving, diet, meal type, and dish type.",
